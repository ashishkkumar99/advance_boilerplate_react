...
- Prettier
- ESLint
- Webpack merge for dev/prod configuartion
...
ESlint is basically used for development purpose. And is not necessary to be included in the build process of webpack. So, we don't need eslint-loader(required for incorporating eslint in webpack).
